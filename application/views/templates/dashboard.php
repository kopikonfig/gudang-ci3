        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-warehouse"></i> <!-- Mengganti ikon university menjadi warehouse -->
                </div>
                <div class="sidebar-brand-text mx-3">CV.INDO ZAMZAM</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span> Teknik Industri UINSUKA 2024 </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
